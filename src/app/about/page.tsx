...
const About = () => {
  return (
    <div className="bg-white text-gray-800 p-10">
      <h1 className="text-3xl font-bold mb-5 text-center text-yellow-600">About Us</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-100 p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2 text-yellow-600">Quality Materials</h2>
          <p>We use only the best materials to craft furniture that lasts.</p>
        </div>
        <div className="bg-gray-100 p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2 text-yellow-600 ">Custom Designs</h2>
          <p>Each piece is uniquely designed to match modern aesthetics.</p>
        </div>
        <div className="bg-gray-100 p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-2 text-yellow-600  ">Affordable Prices</h2>
